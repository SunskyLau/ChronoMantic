...
from model.MyTypes import QuerySpec, ValueCondition
from model.model import generate_best_segments, generate_tobecalculated_fragments
...
# 生成片段
fragments = generate_tobecalculated_fragments(querySpec, data["Date"], data["AMZN"])
...
for fragment in fragments:
    ...
    generate_best_segments(x, fragment_values.values, 8)
