    ...
    return (
        <>
            <Flex gap={12} align="center">
                ...
                <InputNumber disabled={disabled} addonAfter={addonAfter} max={maxValue} min={minValue} value={min ? min / valueFormatter : min} onChange={(value) => { onChange(value ? value * valueFormatter : null, max, minInclusive, maxInclusive); }} />
                <SwapRightOutlined />
                <InputNumber disabled={disabled} addonAfter={addonAfter} max={maxValue} min={minValue} value={max ? max / valueFormatter : max} onChange={(value) => { onChange(min, value ? value * valueFormatter : null, minInclusive, maxInclusive); }} />
